        ...
        <div className="lg:col-span-2 group">
          <Link href={`/article/${FEATURED.id}`}>
            <div className="overflow-hidden rounded-sm">
              <div
                className={`w-full h-64 sm:h-80 md:h-105 bg-linear-to-br ${FEATURED.gradient} flex items-center justify-center relative`}
              >
                {/* Video briefing overlay */}
                <div className="text-center text-white">
                  <div className="flex h-16 w-16 mx-auto items-center justify-center rounded-full bg-white/20 backdrop-blur-sm transition-transform group-hover:scale-110">
                    <Play className="h-7 w-7 fill-white text-white" />
                  </div>
                  <p className="mt-3 text-sm font-medium">
                    🎬 Today&apos;s AI Video Briefing
                  </p>
                  <p className="text-xs text-white/70">
                    2:30 · Generated by MiniMax
                  </p>
                </div>
